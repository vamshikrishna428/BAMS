...
public class SampleTest {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement selectbus = driver
				.findElement(By.xpath("//div[@class='MuiFormControl-root MuiFormControl-fullWidth css-1mejovb']"));
		selectbus.click();
		...
		WebElement empid = driver
				.findElement(By.xpath("//div[@class='MuiGrid-root css-1rlxlch']/descendant::input[@name='empId']"));
		j.executeScript("arguments[0].value = '';", empid);
		Thread.sleep(2000);
		j.executeScript("arguments[0].value = 'Yash123';", empid);

		WebElement empname = driver
				.findElement(By.xpath("//div[@class='MuiGrid-root css-1rlxlch']/descendant::input[@name='firstName']"));
		j.executeScript("arguments[0].value = '';", empname);
		Thread.sleep(2000);
		j.executeScript("arguments[0].value = 'YashChopra';", empname);
		Thread.sleep(2000);

		WebElement updatelicense = driver.findElement(By.xpath(
				"//div[@class='MuiGrid-root jss32 css-rfnosa']/descendant::p[contains(text(),'Update License')]"));
		if (updatelicense.isDisplayed()) {
			...
			driver.findElement(
					By.xpath("//div[@class='MuiGrid-root jss42 css-rfnosa']/descendant::p[contains(text(),'Back')]"))
					.click();
		}
